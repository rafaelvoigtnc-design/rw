...
import { Search, Filter, Plus, Edit, Trash2, X, Phone, Mail, MapPin, Calendar, User, Clock } from 'lucide-react';
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Principal forma de contato</p>
              </div>
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Usado apenas para login</p>
              </div>
              <div>
